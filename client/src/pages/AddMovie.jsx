...
const AddMovie = () => {
    ...
    return (
        <div className="max-w-4xl mx-auto bg-base-200 p-8 rounded-xl dark:bg-gray-800">
            <h2 className="text-3xl font-bold text-center mb-8">Add New Movie</h2>
            <form onSubmit={handleAddMovie} className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="form-control">
                    ...
                    <input type="text" name="title" placeholder="Inception" className="input input-bordered" required />
                </div>

                <div className="form-control">
                    <label className="label"><span className="label-text">Poster URL</span></label>
                    <input type="url" name="posterUrl" placeholder="https://example.com/poster.jpg" className="input input-bordered" required />
                </div>

                <div className="form-control">
                    <label className="label"><span className="label-text">Genre (Hold Ctrl to select multiple)</span></label>
                    <select name="genre" className="select select-bordered h-32" multiple required>
                ...
                <div className="space-y-4">
                    <div className="form-control">
                        ...
                        <input type="number" name="duration" placeholder="148" className="input input-bordered" required />
                    </div>
                    <div className="form-control">
                        <label className="label"><span className="label-text">Release Year</span></label>
                        <input type="number" name="releaseYear" placeholder="2010" className="input input-bordered" required />
                    </div>
                    <div className="form-control">
                        <label className="label"><span className="label-text">Rating (0-10)</span></label>
                        <input type="number" name="rating" placeholder="8.8" step="0.1" min="0" max="10" className="input input-bordered" required />
                    </div>
                </div>

                <div className="form-control">
                    <label className="label"><span className="label-text">Director</span></label>
                    <input type="text" name="director" placeholder="Christopher Nolan" className="input input-bordered" required />
                </div>

                <div className="form-control">
                    <label className="label"><span className="label-text">Cast (comma separated)</span></label>
                    <input type="text" name="cast" placeholder="Leonardo DiCaprio, Joseph Gordon-Levitt" className="input input-bordered" required />
                </div>

                <div className="form-control">
                    <label className="label"><span className="label-text">Language</span></label>
                    <input type="text" name="language" placeholder="English" className="input input-bordered" required />
                </div>

                <div className="form-control">
                    <label className="label"><span className="label-text">Country</span></label>
                    <input type="text" name="country" placeholder="USA" className="input input-bordered" required />
                </div>

                <div className="form-control md:col-span-2">
                    <label className="label"><span className="label-text">Plot Summary</span></label>
                    <textarea name="plotSummary" className="textarea textarea-bordered h-24" placeholder="A thief who steals corporate secrets..." required></textarea>
                </div>

                <div className="form-control md:col-span-2 mt-4">
                    <button className="btn btn-primary w-full">Add Movie</button>
                </div>
            </form>
        </div>
    );
